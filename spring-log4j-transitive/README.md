...
3. **Log4j 2.x Backend**: Log4j 2.x handles the actual logging implementation
4. **Modern Pattern**: This represents the recommended approach for Spring applications
...
- ✅ Removed explicit `log4j:log4j` dependency
...
You'll see that `log4j-api` and `log4j-core` version 2.23.1 are used through `log4j-slf4j-impl`.
